...
ax1.set_title('Overall User Perception (n=413)', fontweight='bold', fontsize=12)
plt.tight_layout()
...
ax2.set_title('User Perception by Post (%)', fontweight='bold', fontsize=12)
...
ax3.pie(sentiment_counts,
        ...
        startangle=90, textprops={'fontsize': 11})
ax3.set_title('Overall User Sentiment (n=413)', fontweight='bold', fontsize=12)
plt.tight_layout()
